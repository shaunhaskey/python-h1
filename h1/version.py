"""
Current h1 version constant plus version pretty-print method.
...
def get_module_urls():
    return ("https://code.h1svr.anu.edu.au/projects/python-h1", "https://code.h1svr.anu.edu.au/projects/python-h1/issues/new", )
